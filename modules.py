...
class ZINBGAE(Module):  
    def __init__(self, x, hidden_dim=40, latent_dim=400):  
        ...
        self.dec1 = Linear(x.shape[1], latent_dim)  
        self.bn2 = BatchNorm1d(latent_dim)  
        self.dr2 = nn.Dropout(0.4)  
        self.dec2 = Linear(latent_dim, x.shape[1])  
    ...
    def forward(self, x, adj, size_factors=1.0):  
        ...
        return x_recon, _mean, _disp, _pi
